...
{%- set java_home         = salt['grains.get']('java_home', salt['pillar.get']('java_home', '/usr/lib/jvm/jre')) %}
...
{%- set default_url       = 'https://archive.apache.org/dist/zookeeper/' + version_name + '/' + version_name + '.tar.gz' %}
